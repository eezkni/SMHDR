...
def get_args():
    ...
    parser.add_argument('--start_epoch', type=int, default=301, metavar='N',
    ...
    parser.add_argument('--resume', type=str, default='',
                        help='load model from a .pth file (default: None)')   # ckpt path <<<========
...
def main():
    ...
    for epoch in range(args.start_epoch, args.epochs + 1):
        ...
        logger_train.info(f'===> Epoch: {epoch}/{args.epochs} | Mask ratio: {args.mask_ratio}')
        tb_writer.add_scalar('train/mask_ratio', args.mask_ratio, epoch)
        print(f'===> Epoch: {epoch}/{args.epochs} | Mask ratio: {args.mask_ratio}')
        ...
        if epoch == 301:
            print(f"==> start test of epoch {epoch-1}.")
            test(args, model, device, optimizer, lr_scheduler, epoch-1, test_loader, ckpt_dir)
